...
public class InterfazGRafica extends javax.swing.JFrame {
    ...
    public InterfazGRafica() {
        ...
        //perecedero2.agregarLote(l2);
        perecedero2.agregarLote(l1);
        
        //perecedero3.agregarLote(l4);
        //perecedero3.agregarLote(l3);
    ...
    private void initComponents() {
        ...
        cajonNombreElectronico = new javax.swing.JTextField();
        cajaPrecioElectronicos = new javax.swing.JTextField();
        cajaMarcaElectronicos = new javax.swing.JTextField();
        ...
        cajaMaterial = new javax.swing.JTextField();
        ...
        comboBoxOrdenar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        cajonNombreElectronico.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        cajonNombreElectronico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajonNombreElectronicoActionPerformed(evt);
            }
        });
        fondoAgregarElectronico.add(cajonNombreElectronico, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, 240, 30));

        cajaPrecioElectronicos.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        cajaPrecioElectronicos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaPrecioElectronicosActionPerformed(evt);
            }
        });
        fondoAgregarElectronico.add(cajaPrecioElectronicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 170, 240, 30));

        cajaMarcaElectronicos.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        cajaMarcaElectronicos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaMarcaElectronicosActionPerformed(evt);
            }
        });
        fondoAgregarElectronico.add(cajaMarcaElectronicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 240, 30));

        jLabel32.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel32.setText("NOMBRE");
        fondoAgregarElectronico.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 240, 30));

        jLabel33.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel33.setText("PRECIO");
        fondoAgregarElectronico.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 240, 30));

        jLabel34.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel34.setText("MARCA");
        fondoAgregarElectronico.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 240, 30));

        jLabel38.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel38.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel38.setText("SISTEMA OPERATIVO");
        fondoAgregarElectronico.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 240, 30));

        cajaSistemaOperativo.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        cajaSistemaOperativo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaSistemaOperativoActionPerformed(evt);
            }
        });
        fondoAgregarElectronico.add(cajaSistemaOperativo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 240, 30));

        jLabel39.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel39.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel39.setText("MATERIAL");
        fondoAgregarElectronico.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 320, 240, 30));

        cajaMaterial.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        fondoAgregarElectronico.add(cajaMaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 330, 240, 30));
        ...
        fondoAgregarElectronico.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 410, 240, 30));

        jLabel6.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("ELECTRONICOS");
        fondoAgregarElectronico.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 50, 300, 50));
    ...
    private void cajonNombreElectronicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajonNombreElectronicoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajonNombreElectronicoActionPerformed

    private void cajaPrecioElectronicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajaPrecioElectronicosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaPrecioElectronicosActionPerformed

    private void cajaMarcaElectronicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajaMarcaElectronicosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaMarcaElectronicosActionPerformed
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String nombreElectronico=cajonNombreElectronico.getText();
        double precioElectronico =Double.parseDouble(cajaPrecioElectronicos.getText());
        String marcaElectronico = cajaMarcaElectronicos.getText();
        String sisOpe = cajaSistemaOperativo.getText();
        String material = cajaMaterial.getText();
        
        Producto nuevo = new Electronico(nombreElectronico,precioElectronico,marcaElectronico,sisOpe,material);
        inventario.agregarProducto(nuevo);
        mensajeAgragarElectronico.setText("Producto electronico agregado con exito");
        
        cajonNombreElectronico.setText("");
        cajaPrecioElectronicos.setText("");
        cajaMarcaElectronicos.setText("");
        cajaSistemaOperativo.setText("");
        cajaMaterial.setText("");
    ...
    private javax.swing.JTextField cajaMarcaElectronicos;
    private javax.swing.JTextField cajaMarcaIndumentaria;
    private javax.swing.JTextField cajaMaterial;
    ...
    private javax.swing.JTextField cajaPrecioElectronicos;
    ...
    private javax.swing.JTextField cajonNombreElectronico;
